...
class Ticket {
  ...
  async createTicketInicio(corpo_texto, data_limite, sub, doc1, doc2, eProfessor){
    try{
      ...
      var id_processo_estagio = await knex.returning('id').insert({id_tipo_estagio: 0, situação: null, data_criado: data_criado, data_fechado: null}).table('processo_estagio')
